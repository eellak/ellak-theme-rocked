                    ...
                    <div id="ellak-diadose-bar" class="ellak-diadose">
                        ...
                        <div class="ellak-diadose-non-text-wrap">
                            <div class='ellak-diadose-logo-wrap'>
                                <a href="http://opensource.ellak.gr"><img src="<?php echo get_template_directory_uri(); ?>/images/diadose-bar/logow.png"></a>
                            </div>
                            <div class="ellak-diadose-orange-frame"></div>
                            <div class='ellak-diadose-birds'>
                                <img src="<?php echo get_template_directory_uri(); ?>/images/diadose-bar/birds-custom.png" alt="freedom">
                            </div>
                        </div>
                    </div>
                </div>
